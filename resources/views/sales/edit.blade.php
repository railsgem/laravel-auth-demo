...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
		...
		<a href="/admin/sales"><i class="fa fa-angle-double-left"></i> Back to all  <span class="text-lowercase">sales</span></a><br><br>
		  <form method="POST" action="/admin/sales/update/{{ $sales_item->id }}" accept-charset="UTF-8">
              {{ csrf_field() }}
    		    ...
    		    <div class="box-body row">
    		      <!-- load the view from the application if it exists, otherwise load the one in the package -->
                    ...
                    <div class="form-group col-md-12 {{ $errors->has('sales_person_name') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" id="sales_person_name" name="sales_person_name" value="{{ $sales_item->sales_person_name ? $sales_item->sales_person_name :old('sales_person_name')  }}" placeholder="sales_person_name">
